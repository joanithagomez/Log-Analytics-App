            ...
            <div className="side-c">
                <ul className="tab">
                    ...
                    <svg width= "22px" height= "20px" viewBox="0 0 22 20" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                        ...
                        <defs></defs>
                        <g id="Page-1"stroke-width="3" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                            <g id="bar-chart-2" transform="translate(1.000000, 1.000000)"  stroke-width="3">
                    ...
                    <i className="icon">
                        ...
                        <svg width= "22px" height= "20px" viewBox="0 0 22 22" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs></defs>
                            <g id="Page-1" stroke-width="3" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                                <g id="pie-chart" transform="translate(0.000000, 1.000000)" stroke-width="3">
                    ...
                    <li ><Link className="tab-link"to='/usageanalysis'>
                        ...
                        <i className="icon">                       
                                ...
                                <g id="Page-1" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                                    <g id="Manage-Files" transform="translate(-23.000000, -508.000000)" stroke-width="3">
